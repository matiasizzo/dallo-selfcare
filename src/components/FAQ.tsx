      ...
      >
        ...
        <motion.div
          ...
          className={`flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center transition-colors ${
            isOpen ? 'bg-brand-600 text-white' : 'bg-neutral-100 text-neutral-600'
          }`}
        >
        ...
        <div className="grid lg:grid-cols-[1fr_1.4fr] gap-16 items-start">
          ...
          >
            ...
            <motion.a
              variants={fadeUp}
              href="#contact"
              className="inline-flex items-center gap-2 px-5 py-3 bg-brand-600 hover:bg-brand-700 text-white text-sm font-medium rounded-full transition-colors w-fit mt-2"
            >
