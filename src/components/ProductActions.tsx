          ...
          <div className="flex flex-wrap gap-2">
            {activeVariants.map((v) => (
              <button
                ...
                className={`border px-4 py-2 text-xs font-sans transition-colors ${
                  selected.id === v.id
      ...
      <div className="flex gap-3 items-stretch">
        <div className="flex items-center border border-sand-400">
          <button
            ...
            className="px-3 py-3 text-text hover:text-cocoa-900 transition-colors"
        ...
        <button
          onClick={handleAdd}
          disabled={outOfStock}
          className="flex-1 bg-cocoa-900 text-sand-100 text-xs tracking-[0.2em] uppercase py-3 font-sans hover:bg-cocoa-800 transition-colors disabled:opacity-50"
        >
